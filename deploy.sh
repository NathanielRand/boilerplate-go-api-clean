...
gcloud run deploy webchest-image-converter-api --image gcr.io/webchest/webchest-image-converter-api --platform managed --region us-east1 --memory 1Gi --allow-unauthenticated
