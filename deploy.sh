...
gcloud run deploy webchest-image-converter-api --image gcr.io/webchest/webchest-image-converter-api --platform managed --region us-east1 --memory '512MiB' --cpu '1' --min-instances '0' --allow-unauthenticated
